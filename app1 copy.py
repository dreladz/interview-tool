...
#     if st.button("Start Inverview", on_click=complete_setup):
...
#         model="gpt-5.6-luna",
#         messages=[
#             {"role": "system", "content": """You are a helpful tool taht provides feedback on an interviewee performance. Before the Feedback give a score of 1 to 10. Follow this format: 
#             Overal Score: //Your score
#             Feedback: //Here you put your feedback
#             Give only the feedback do not ask any additional questions"""},
#             {"role": "user", "content": f"This is the interview you need to evaluate. Keep in mind that you are only a tool that provides feedback on the interviewee performance. Do not ask any additional questions. {conversation_history}"}
#         ]
#     )
